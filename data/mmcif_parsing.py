...
class MmcifObject:
  ...
  author_chain_id_to_mmcif:  Mapping[ChainId, ChainId]
  raw_string: Any
...
def parse(*,
  ...
  try:
    ...
    author_chain_id_to_mmcif = {v: k for k, v in mmcif_to_author_chain_id.items()}
    mmcif_object = MmcifObject(
        ...
        author_chain_id_to_mmcif = author_chain_id_to_mmcif,
